...
func extractExifFields(filePath string, meta *ImageMetadata) {
	f, err := os.Open(filePath)
	if err != nil {
		return
	}
...
func hasExifData(meta *ImageMetadata) bool {
...
// unused import guard for time package used in ImageMetadata
var _ = time.Now
